...
public class Barrera {
    ...
    public String toString() {
        return "                     Barrera " + "\n" + " \n Nombre: " + Nombre + " \n Voltaje: " + Voltaje + " \n Imagenes por Semana: " + ImagenesxSemana + " \n Tipo de Barrera: " + TipoBarrera + " \n Ã�rea a Proteger: " + AreaProteger + " \n DiseÃ±o de Ã�rea: " + DisenioDeArea + " \n Distancia: " + Distancia + " \n Factor De Transmision: " + factorDeTransmision + " \n Carga De Trabajo: " + cargaDeTrabajo + " \n Factor De Uso: " + factorDeUso + " \n Factor De Ocupacion: " + factorDeOcupacion + " \n Dosis Limite De DiseÃ±o: " + dosisDeLimiteDeDisenio + " \n Bp: " + String.format("%.2f", bp) + "\n \n                    Espesor: " + " \n \n Acero: " + String.format("%.2f", acero) + " \n \n Plomo: " + String.format("%.2f", plomo) + " \n \n Concreto: " + String.format("%.2f", concreto) ;
    }
